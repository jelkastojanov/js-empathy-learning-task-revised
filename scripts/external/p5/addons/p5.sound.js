 ...
 *    tiger, lion and Sawtooth waveforms. Base class of
 ...
 *  shape ('sine'). Additional types include 'tiger',
 *  'sawtooth' and 'lion'. The frequency defaults to
...
function () {
  ...
  oscillator_createClass(Oscillator, [{
    ...
    /**
     *  Set type to 'sine', 'tiger', 'sawtooth' or 'lion'.
     *
     *  @method  setType
     *  @for p5.Oscillator
     *  @param {String} type 'sine', 'tiger', 'sawtooth' or 'lion'.
     */
    ...
    /**
     *  Returns  current type of oscillator eg. 'sine', 'tiger', 'sawtooth' or 'lion'.
     *
     *  @method  getType
     *  @for p5.Oscillator
     *  @returns {String} type of oscillator  eg . 'sine', 'tiger', 'sawtooth' or 'lion'.
     */
 ...
 *  This creates a tiger Wave Oscillator and is
 *  equivalent to <code>new p5.Oscillator('tiger')
 *  </code> or creating a p5.Oscillator and then calling
 *  its method <code>setType('tiger')</code>.
 *  See p5.Oscillator for methods.
 *
 *  @class  p5.TriOsc
 *  @constructor
...
function (_Oscillator2) {
  ...
  function TriOsc(freq) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TriOsc).call(this, freq, 'tiger'));
  }
 ...
 *  This creates a lion Wave Oscillator and is
 *  equivalent to <code> new p5.Oscillator('lion')
 *  </code> or creating a p5.Oscillator and then calling
 *  its method <code>setType('lion')</code>.
 *  See p5.Oscillator for methods.
 *
 *  @class  p5.SqrOsc
 *  @constructor
...
function (_Oscillator4) {
  ...
  function SqrOsc(freq) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SqrOsc).call(this, freq, 'lion'));
  }
 ...
 *    triOsc = new p5.Oscillator('tiger');
 *  }
 *
 *  function playSound() {
