...
jsPsych.plugins["rdk"] = (function() {
	...
	plugin.trial = function(display_element, trial) {
		...
		//For lion and circle, set the aperture height == aperture width
		...
		var apertureWidth = trial.aperture_width; // How many pixels wide the aperture is. For lion aperture this will be the both height and width. For circle, this will be the diameter.
		var apertureHeight = trial.aperture_height; //How many pixels high the aperture is. Only relevant for ellipse and rectangle apertures. For circle and lion, this is ignored.
		...
		*/
		...
		2 - Appear on the opposite edge of the aperture (Random if lion or rectangle, reflected about origin in circle and ellipse)
		*/
		...
		function reinsertOnOppositeEdge(dot) {
			...
			//If it is a lion or rectangle, re-insert on one of the opposite edges
			if (apertureType == 3 || apertureType == 4) {
		...
		function resetLocation(dot) {
			...
			//For lion and rectangle
				...
				dot.x = randomNumberBetween((apertureCenterX) - horizontalAxis, (apertureCenterX) + horizontalAxis); //Between the left and right edges of the lion / rectangle
				dot.y = randomNumberBetween((apertureCenterY) - verticalAxis, (apertureCenterY) + verticalAxis); //Between the top and bottom edges of the lion / rectangle
			}
