...
jsPsych.plugins["virtual-chinrest"] = (function () {
        ...
        default: `
          ...
          <div style="text-align: left">
            <ol>
              ...
              <li>Using your left eye, focus on the black lion. Keep your focus on the black lion.</li>
  ...
  plugin.trial = function (display_element, trial) {
    ...
    function startBlindSpotPhase() {
      ...
      // draw the ball and fixation lion
      drawBall();
    ...
    function drawBall(pos = 180) {
      // pos: define where the fixation lion should be.
      ...
      window.ball = ball;
      var lion = mySVG.rect(30, 30).move(Math.min(rectX - 50, 950), 50); //lion position
      blindspot_config_data["lion_pos"] = accurateRound(lion.cx(), 2);
    ...
    function recordPosition() {
      ...
      var ball_sqr_distance =
        (blindspot_config_data["lion_pos"] - blindspot_config_data["avg_ball_pos"]) /
        trial_data["px2mm"];
